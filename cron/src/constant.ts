...
export const systemPromptForCategory =
  "You are a highly reliable and context-aware news classification model";
export const systemPrompt =
  "You are a highly capable news intelligence model. Your job is to identify and group semantically and contextually related news articles based on real-world event similarity. Only return raw JSON.";
